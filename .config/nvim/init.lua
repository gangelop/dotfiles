...
require('lazy').setup({
  ...
  'sherifkandeel/vim-colors', -- name: vimbrains,
...
local goFormat = vim.api.nvim_create_augroup('goFormat', { clear = true })
...
local goOrganizeImports = vim.api.nvim_create_augroup('goOrganizeImports', { clear = true })
vim.api.nvim_create_autocmd({ "InsertLeave", "BufWritePre" }, {
  pattern = "*.go",
  group = goOrganizeImports,
...
vim.keymap.set('n', '<leader>rr', function() vim.o.relativenumber = not vim.o.relativenumber end, { desc = 'Toggle relative numbers' })
vim.keymap.set('n', '<leader>ss', function() vim.o.spell = not vim.o.spell end, { desc = 'Toggle spellcheck' })
--}}}
--------------------------------------------------------------------------------

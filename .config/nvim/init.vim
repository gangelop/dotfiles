...
" " skeletons " {{{
"-----------------"
au! BufNewFile *.html  0r ~/.config/nvim/skeleton/skeleton.html
au! BufNewFile *.sh    0r ~/.config/nvim/skeleton/skeleton.sh
au! BufNewFile *.zsh    0r ~/.config/nvim/skeleton/skeleton.zsh
au! BufNewFile *.c     0r ~/.config/nvim/skeleton/skeleton.c
au! BufNewFile *.pl     0r ~/.config/nvim/skeleton/skeleton.pl
au! BufNewFile *.py     0r ~/.config/nvim/skeleton/skeleton.py
"-----------------"}}}
" vim:fdm=marker
